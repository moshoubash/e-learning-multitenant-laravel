...
<body class="font-sans antialiased bg-gray-50"
    ...
    <div class="fixed top-0 z-40 transition-all duration-300 ease-in-out"
         :style="`${isRtl ? 'right' : 'left'}: ${sidebarCollapsed ? '3rem' : '15rem'}; width: calc(100% - ${sidebarCollapsed ? '3rem' : '15rem'})`">
    ...
    <div class="pt-16 transition-all duration-300 ease-in-out"
         :style="`padding-${isRtl ? 'right' : 'left'}: ${sidebarCollapsed ? '3rem' : '15rem'}`">
