    ...
    <form wire:submit="login" class="space-y-6">
        ...
        <div class="pt-2">
            <button type="submit"
                ...
                style="background-color: var(--color-primary-container, #FFD600); border: 2px solid var(--color-on-surface, #0A0A0A); border-radius: 4px; color: var(--color-auth-on-primary, #0A0A0A);"
