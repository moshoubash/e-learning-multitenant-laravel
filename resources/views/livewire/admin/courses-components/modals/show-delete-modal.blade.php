@if($showDeleteModal && $deletingCourse)
                ...
                <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ltr:ml-4 sm:rtl:mr-4 sm:ltr:text-left rtl:text-right">
                            <h3 class="text-sm font-bold uppercase tracking-widest text-on-surface">{{ __('messages.Delete Course') }}</h3>
                            <p class="mt-2 text-sm text-secondary">
                                {{ __('messages.Are you sure you want to delete this course? This action cannot be undone.') }}
                            </p>
                            <div class="mt-4 p-3 bg-surface-container-low neo-border-sm neo-radius">
                                <p class="font-bold text-sm text-on-surface">{{ $deletingCourse->title }}</p>
                            </div>
                        </div>
                    </div>
                </div>
