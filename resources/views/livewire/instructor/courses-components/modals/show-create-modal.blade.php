                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <form>
                        <div class="mb-4">
                            ...
                            <input type="file" wire:model="createAvatar" accept="image/*"
                                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            @error('createAvatar') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                            @if($createAvatar)
                                <div class="mt-2">
                                    <img src="{{ $createAvatar->temporaryUrl() }}" class="w-20 h-20 object-cover rounded-md">
                                </div>
                            @endif
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            @error('createStatus') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            @error('createInstructorId') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                        </div>
                    </form>
                </div>
