                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <form>
                        <div class="mb-4">
                            ...
                            @error('quizEditTitle') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                        </div>
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('Lesson') }}</label>
                            <select wire:model.lazy="quizEditLessonId"
                                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            ...
                            @error('quizEditLessonId') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="number" wire:model.lazy="quizEditPassPercentage" min="1" max="100"
                                class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            @error('quizEditPassPercentage') <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                        </div>
                    </form>
                </div>
