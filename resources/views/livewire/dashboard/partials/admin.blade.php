            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-[#E5E5E5]">
                    @forelse($tables['topCourses'] as $index => $course)
                        <tr>
                            <td class="px-6 py-4 text-xs text-secondary font-bold">{{ $index + 1 }}</td>
                            <td class="px-6 py-4 font-bold text-sm text-on-surface">{{ $course->title }}</td>
                    ...
                    @empty
                        <tr><td colspan="4" class="px-6 py-8 text-center text-sm text-secondary">{{ __('messages.No Enrolled Courses') }}</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
