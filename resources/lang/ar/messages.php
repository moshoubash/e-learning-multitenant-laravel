...
return [
    ...
    'Latest' => 'الأحدث',
    'Home' => 'الرئيسية',
    'Track every major update and improvement to the platform.' => 'تتبع كل تحديث وتحسين رئيسي في المنصة.',
    ...
    // Reports
    'Reports' => 'التقارير',
    'Analytics & Insights' => 'التحليلات والإحصاءات',
    ...
    'quizzes' => 'الاختبارات',
    'assignments' => 'الواجبات',
    'New Users Trend' => 'اتجاه المستخدمين الجدد',
    'Top Students by XP' => 'أفضل الطلاب حسب النقاط',
    'XP Points' => 'نقاط الخبرة',
    'Quiz Performance' => 'أداء الاختبارات',
    'Attempts' => 'محاولات',
    'Avg Score' => 'متوسط الدرجات',
    'Completion Rate (%)' => 'معدل الإنجاز (%)',
    'Top Courses by Enrollment' => 'أفضل الدورات حسب التسجيل',
    'Completion Rates' => 'معدلات الإنجاز',
    'Submission Status' => 'حالة التسليم',
    'Quiz Attempts Trend' => 'اتجاه محاولات الاختبارات',
    'Weekly Report' => 'التقرير الأسبوعي',
    'Weekly Analytics Report' => 'تقرير التحليلات الأسبوعي',
    'this week' => 'هذا الأسبوع',
    'Pending Submissions' => 'تسليمات معلقة',
    'Weekly Report Ready' => 'التقرير الأسبوعي جاهز',
    'Generated on' => 'تم التوليد في',
    'Automated Report' => 'تقرير آلي',
    'Hello, :name' => 'مرحباً، :name',
    'Here is your weekly analytics report for :start to :end' => 'هذا تقرير التحليلات الأسبوعي الخاص بك من :start إلى :end',
    'New Users: :count' => 'المستخدمين الجدد: :count',
    'New Enrollments: :count' => 'التسجيلات الجديدة: :count',
    'New Courses: :count' => 'الدورات الجديدة: :count',
    'Quiz Attempts: :count' => 'محاولات الاختبارات: :count',
    'Pending Submissions: :count' => 'التسليمات المعلقة: :count',
    'View Reports' => 'عرض التقارير',
    'Your weekly analytics report has been generated and emailed to you.' => 'تم توليد تقرير التحليلات الأسبوعي الخاص بك وإرساله إلى بريدك الإلكتروني.',
    'Weekly Report - :app' => 'التقرير الأسبوعي - :app',
];
