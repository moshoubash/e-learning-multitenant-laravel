    ...
    private function buildCsp(): string
    {
        ...
        if (app()->environment('production')) {
            return "default-src 'self'; "
                ...
                . "frame-src 'self' https://www.youtube.com https://drive.google.com https://accounts.google.com https://js.stripe.com; "
        ...
        return "default-src 'self'; "
            ...
            . "frame-src 'self' https://www.youtube.com https://drive.google.com https://accounts.google.com https://js.stripe.com {$viteHosts}; "
